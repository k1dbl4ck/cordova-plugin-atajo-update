...
- (NSURL*)appUrl
{
    ...
    NSLog(@"ATAJO:OVERRIDE:CONTROLLER - CURRENT URL IS - %@", appURL);
    
    NSString* reference = @"atajo.code.update.location";
    NSString* updateUrl = [[NSUserDefaults standardUserDefaults] stringForKey:reference];
    
    NSLog(@"ATAJO:OVERRIDE:CONTROLLER - UPDATE URL IS %@", updateUrl);
    
    if ([updateUrl length] >0) {
        
        
        NSMutableArray* directoryParts = [NSMutableArray arrayWithArray:[updateUrl componentsSeparatedByString:@"Documents/"]];
        NSString* documentPath = [directoryParts lastObject];
        NSMutableArray* documentParts = [NSMutableArray arrayWithArray:[documentPath componentsSeparatedByString:@"/"]];
        [documentParts removeLastObject];
        
        NSArray* paths = NSSearchPathForDirectoriesInDomains(NSDocumentDirectory,NSUserDomainMask, YES);
        NSString* documentsDirectory = [paths objectAtIndex:0];
        documentsDirectory = [documentsDirectory stringByAppendingString:@"/"];
        
        NSString* directoryPartsJoined = [documentParts componentsJoinedByString:@"/"];
        
        directoryPartsJoined = [documentsDirectory stringByAppendingString:directoryPartsJoined];
        directoryPartsJoined = [@"file://" stringByAppendingString:directoryPartsJoined];
        directoryPartsJoined = [directoryPartsJoined stringByAppendingString:@"/index.html"];
        
        appURL = [NSURL URLWithString:directoryPartsJoined];
        NSLog(@"ATAJO:OVERRIDE:CONTROLLER - LOADING UPDATED URL %@ ", appURL);
